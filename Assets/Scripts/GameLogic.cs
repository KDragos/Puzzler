...
public class GameLogic : MonoBehaviour {
	...
	public GameObject startUI, restartUI, giveUpUI;
	...
	public Text loseDifficultyText;
	...
	public void setDifficultyText() {
		difficultyText.text = puzzleLength.ToString ();
		loseDifficultyText.text = puzzleLength.ToString ();
	}
